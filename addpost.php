...
echo "================\n\n";
echo "Tip: Account should have same password.\n\n";
...
$headerss = array("Content-Type: application/json", "user-agent:Lyka/3.6.21 (com.thingsilikeapp; build:821 Android R 30)");
...
echo "$White";
echo "\n\nadd posts/moments to $vuser done.\n";
...
function addPosts($user, $bearer, $device_id) {
 //  echo "\nAdding posts to $user \n";
   ...
   $uploadPay = <<<DATA
       {"category":"post","clientId":"$user_id","files":[{"fileName":"/storage/emulated/0/Pictures/Lyka-Nature/n*.jpg", "mediaType":"image"}]}
   DATA; 
...
//   echo "\nAdding moments\n";
   ...
   $uploadLegacy = "https://media.mylykaapps.com/api/v1/media/social/multi-upload-url";
   $uploadPay = <<<DATA
       {"category":"moment","clientId":"$user_id","files":[{"fileName":"/storage/emulated/0/Pictures/Lyka-Nature/n*.jpg", "mediaType":"image"}]}
   DATA; 
   $uploadLegPost = postX($uploadLegacy,$uploadPay,$bearer);
